...
C:\gbdk\bin\lcc -c -o bin\WindowMap.o src\maps\WindowMap.c
...
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -o bin\mine.gb bin\main.o bin\WindowMap.o bin\SplashScreenMap.o bin\MenuMap.o bin\LoseMap.o bin\WinMap.o bin\GameOverMap.o bin\MineMap.o bin\MineTiles.o bin\SplashScreenTiles.o
