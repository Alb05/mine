...
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wf-debug -Wl-y -Wl-w -o bin\mine.gb bin\main.o bin\WindowMap.o bin\SplashScreenMap.o bin\MenuMap.o bin\LoseMap.o bin\WinMap.o bin\GameOverMap.o bin\MineMap.o bin\MineTiles.o bin\SplashScreenTiles.o
